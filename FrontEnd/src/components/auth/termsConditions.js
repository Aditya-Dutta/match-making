...
export default function termsConditions() {
  return (
    <React.Fragment>
      ...
      <p>Welcome to Jaxlooper!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of J.A.S Enterprise's Website, located at www.jaxlooper.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Jaxlooper if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Jaxlooper, you agreed to use
        cookies in agreement with the J.A.S Enterprise's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, J.A.S Enterprise and/or its licensors own the
        intellectual property rights for all material on Jaxlooper. All
        intellectual property rights are reserved. You may access this from
        Jaxlooper for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Jaxlooper</li>
        <li>Sell, rent or sub-license material from Jaxlooper</li>
        <li>Reproduce, duplicate or copy material from Jaxlooper</li>
        <li>Redistribute content from Jaxlooper</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. J.A.S
        Enterprise does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of J.A.S Enterprise,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, J.A.S Enterprise
      ...
      <p>
        J.A.S Enterprise reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant J.A.S Enterprise a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of J.A.S Enterprise; and (d) the
      ...
      <p>
        ...
        e-mail to J.A.S Enterprise. Please include your name, your organization
      ...
      <p>
        No use of J.A.S Enterprise's logo or other artwork will be allowed for
