  ...
  render() {
    return (
      <div>
        ...
        <main>
          <h2>Profile Details of {this.state.profileList.username}</h2>
          <div className="component">
            <article className="job-card">
              <div className="job-title">
                {this.state.profileList.degree_type} Degree
              </div>
              <div className="category">
                Date Of Graduation: {this.state.profileList.date_of_graduation}
              </div>
              <div className="description">
                Summary: {this.state.profileList.summary}{" "}
              </div>
              <div className="skills-container">
                <div className="skill">
                  Location: {this.state.profileList.locationPincode}
                </div>
                <div className="skill">
                  Date Of Graduation:{" "}
                  {this.state.profileList.date_of_graduation}
                </div>
              </div>
